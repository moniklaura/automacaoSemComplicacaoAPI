...
public class FilmesMap {
    ...
    public static void initFilmes(){
        ...
        filme.put("descrição", "Um alerta vermelho da interpol e emitido e o agente do FBI John Hartley" +
                "assume o caso. Durante sua busca, ele se vê diante de um assalto ousado e e forçado a se " +
                "aliar ao maior ladrao de arte da historia, Nolan Booth, para capturar a ladra de arte mais " +
                "procurada do mundo atualemente, Sara Black.");
